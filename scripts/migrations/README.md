...
12. **036–042 markets / sector indexes / stock search / salary history**  
   ...
   - `042` `salary_history` (monthly salary for Freedom Income) — run `node scripts/apply-salary-history.mjs`
