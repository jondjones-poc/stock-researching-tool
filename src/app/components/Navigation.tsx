      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-1">
            {userEmail && (
              <span className="hidden lg:inline text-xs text-gray-500 dark:text-gray-400 mr-2 max-w-[160px] truncate">
                {userEmail}
              </span>
            )}
            <Link
            ...
            <button
              type="button"
              onClick={() => void logout()}
              className="px-4 py-3 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors"
              title="Sign out"
            >
              Sign out
            </button>
          ...
          <div className="flex items-center flex-nowrap gap-x-5">
            {isFinancesTab && (
              <>
                ...
                <Link
                  href="/finances/freedom-income"
                  className={`text-sm font-semibold whitespace-nowrap transition-colors ${
                    pathname === '/finances/freedom-income'
                      ? 'text-blue-600 dark:text-blue-400'
                      : 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400'
                  }`}
                >
